...
const services = [
  {
    title: "Огромный каталог",
    description:
      "Тысячи объявлений о продаже смартфонов: iPhone, Samsung, Xiaomi и другие — с фильтрами по модели, цене и состоянию.",
    mockup: "social",
  },
  {
    title: "Честная оценка",
    description:
      "Калькулятор подскажет реальную рыночную цену вашего телефона по актуальным данным на июнь 2026 года.",
    mockup: "google-ads",
  },
  {
    title: "Чат с продавцом",
    description: "Общайтесь напрямую без посредников: задавайте вопросы и договаривайтесь о цене в личных сообщениях.",
    mockup: "email",
  },
  {
    title: "Проверка телефона",
    description:
      "Проверяем IMEI на блокировки и кражу, чтобы вы покупали только чистые и легальные устройства.",
    mockup: "seo",
  },
  {
    title: "Личный кабинет",
    description:
      "Управляйте объявлениями, отслеживайте просмотры, избранное и историю сделок в удобном профиле.",
    mockup: "analytics",
  },
  {
    title: "Безопасная сделка",
    description:
      "Оплата защищена: деньги получает продавец только после того, как покупатель подтвердит получение телефона.",
    mockup: "web-dev",
    badges: [
      { icon: <Shield className="w-4 h-4" />, text: "Защита платежей" },
      { icon: <DollarSign className="w-4 h-4" />, text: "Без переплат" },
      { icon: <CheckCircle className="w-4 h-4" />, text: "Гарантия сделки" },
    ],
  },
]
  ...
  return (
    <section id="services" className="py-24 bg-black relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6">Всё для удобной сделки</h2>
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            Покупайте и продавайте смартфоны быстро, выгодно и безопасно.
          </p>
        </motion.div>
